...
class AppController final : public QObject {
    ...
    Q_PROPERTY(QVariantMap coursePlan READ coursePlan NOTIFY coursePlanChanged)
    Q_PROPERTY(QUrl coursePlanMapSource READ coursePlanMapSource
                   NOTIFY coursePlanChanged)
    Q_PROPERTY(int plannerHole READ plannerHole WRITE setPlannerHole
                   NOTIFY plannerHoleChanged)
    Q_PROPERTY(QVariantList courseAnalysisLayups READ courseAnalysisLayups
                   NOTIFY courseAnalysisChanged)
    Q_PROPERTY(bool selectedCourseHasAnalysis READ selectedCourseHasAnalysis
                   NOTIFY courseAnalysisChanged)
    Q_PROPERTY(int selectedCourseAnalyzedHoleCount
                   READ selectedCourseAnalyzedHoleCount
                   NOTIFY courseAnalysisChanged)
    Q_PROPERTY(QVariantList integrations READ integrations CONSTANT)
    Q_PROPERTY(QVariantList scorecard READ scorecard NOTIFY scorecardChanged)
    Q_PROPERTY(QString coursePickerMode READ coursePickerMode NOTIFY coursePickerModeChanged)
    Q_PROPERTY(bool searching READ searching NOTIFY searchingChanged)
    Q_PROPERTY(bool downloading READ downloading NOTIFY downloadingChanged)
    Q_PROPERTY(
        double downloadProgress READ downloadProgress NOTIFY downloadProgressChanged)
    ...
    Q_PROPERTY(
        QString selectedCourseSlug READ selectedCourseSlug NOTIFY selectionChanged)
    Q_PROPERTY(
        QString selectedCourseName READ selectedCourseName NOTIFY selectionChanged)
    ...
    Q_PROPERTY(
        double textScale READ textScale WRITE setTextScale NOTIFY settingsChanged)
    Q_PROPERTY(bool showAdvancedScores READ showAdvancedScores WRITE
                   setShowAdvancedScores NOTIFY settingsChanged)
    Q_PROPERTY(bool automaticHoleAdvance READ automaticHoleAdvance WRITE
                   setAutomaticHoleAdvance NOTIFY settingsChanged)
    Q_PROPERTY(int courseHandicap READ courseHandicap WRITE setCourseHandicap
                   NOTIFY settingsChanged)
    Q_PROPERTY(double recommendationBias READ recommendationBias WRITE
    ...
    Q_PROPERTY(
        int brightness READ brightness WRITE setBrightness NOTIFY settingsChanged)
    Q_PROPERTY(QVariantMap mapColors READ mapColors NOTIFY settingsChanged)
    Q_PROPERTY(QString openGolfMapServer READ openGolfMapServer WRITE
                   setOpenGolfMapServer NOTIFY settingsChanged)
    Q_PROPERTY(bool openGolfMapReachable READ openGolfMapReachable
                   NOTIFY courseServiceChanged)
    Q_PROPERTY(QString message READ message NOTIFY messageChanged)
    Q_PROPERTY(QString celebrationKind READ celebrationKind NOTIFY celebrationChanged)
    Q_PROPERTY(
        int celebrationSequence READ celebrationSequence NOTIFY celebrationChanged)

  public:
    AppController(storage::Database *database, courses::CourseProvider *provider,
                  positioning::PositionProvider *positionProvider,
                  platform::PowerProvider *powerProvider, QString coursesRoot,
    ...
    [[nodiscard]] QVariantMap coursePlan() const;
    [[nodiscard]] QUrl coursePlanMapSource() const;
    [[nodiscard]] int plannerHole() const;
    void setPlannerHole(int hole);
    [[nodiscard]] QVariantList courseAnalysisLayups() const;
    [[nodiscard]] bool selectedCourseHasAnalysis() const;
    [[nodiscard]] int selectedCourseAnalyzedHoleCount() const;
    [[nodiscard]] QVariantList integrations() const;
    [[nodiscard]] QVariantList scorecard() const;
    [[nodiscard]] QString coursePickerMode() const;
    ...
    [[nodiscard]] int courseHandicap() const;
    void setCourseHandicap(int handicap);
    ...
    [[nodiscard]] bool openGolfMapReachable() const;
    [[nodiscard]] QString message() const;
    [[nodiscard]] QString celebrationKind() const;
    [[nodiscard]] int celebrationSequence() const;
    ...
    Q_INVOKABLE void openCoursePicker(const QString &mode);
    Q_INVOKABLE void activateCourse(const QString &slug);
    Q_INVOKABLE void planCourse(const QString &slug);
    Q_INVOKABLE void prepareRound(const QString &slug);
    Q_INVOKABLE void startRound(const QString &slug, int holes, bool stableford,
                                int courseHandicap, const QString &tee,
                                bool importCourseAnalysis);
    Q_INVOKABLE bool saveCourseAnalysis(int hole, const QVariantList &points);
    Q_INVOKABLE bool clearCourseAnalysis(int hole);
    ...
    Q_INVOKABLE void refreshStatistics(const QString &courseSlug = {});
    Q_INVOKABLE void selectHistoryRound(const QString &roundId);
    Q_INVOKABLE bool deleteRound(const QString &roundId);
    Q_INVOKABLE QString exportRound(const QString &roundId, const QString &format);
  ...
  signals:
    ...
    void coursePlanChanged();
    void plannerHoleChanged();
    void courseAnalysisChanged();
    void coursePickerModeChanged();
    ...
    void messageChanged();
    void celebrationChanged();
    void scoreEntryRequested(int hole);
  ...
  private:
    ...
    void rebuildCoursePlan(const QVariantMap &course);
    ...
    domain::NearGreenTrigger m_nearGreenTrigger;
    ...
    QVariantMap m_coursePlan;
    QVariantList m_integrations;
    QVariantList m_scorecard;
    QString m_coursePickerMode = QStringLiteral("start");
    ...
    QString m_message;
    QString m_celebrationKind;
    int m_celebrationSequence = 0;
    QSet<int> m_celebratedHoles;
};
